<%-- 
    ...
    Created on : 17/11/2021, 07:58:24 PM
    Author     : VALERY
--%>
...
<html>
    ...
    <head>
        <link rel="icon" href="estructura/favicon.png">
    ...
    <body>
      <link rel="icon" href="estructura/favicon.png">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <a class="navbar-brand"  href="#"><i><img src="estructura/logoit.png" width="128" height="auto"></i> </a>
                ...
                <tbody>
                    <c:forEach var="p" items="${productos}">
                        <tr class="text-center">
                            ...
                            <td>${p.getNombres()}</td>
                            <td>
                            <img src="ControladorIMG?id=${p.getId()}" width="100" height="100"> </td>
